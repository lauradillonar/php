...
//Si $num_regs es igual a 0, insertamos datos en la tabla, sino mandamos un mensaje que diga que el usuario existe
if($num_regs==0)
{
    ...
    //Si el usuario no subió imagen, la foto en el formulario viene vacía, entonces le asigno el valor de la imagen genérica, sino entonces el nombre de la foto que se subio.
    $imagen = empty($archivo)?$imagen_generica:$se_subio_imagen;
    
    $consulta = "INSERT INTO contactos  (email, nombre,sexo,nacimiento,telefono,id_pais,imagen) VALUES ('$email','$nombre','$sexo','$nacimiento','$telefono',$pais,'$imagen')"; 
