...
function subir_imagen($tipo,$imagen,$email)
{
    ...
    if(strstr($tipo,"image"))
    {
        ...
        {
            //reajustamos
            // Por regla de 3 obtengo el alto de la imagen de manera proporcional al ancho nuevo que sera de 420px
